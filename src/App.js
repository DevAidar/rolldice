...
const App = () => {
	...
	return (
		<div className="App">
			<Canvas shadowMap colorManagement gl={{ alpha: false, antialias: true, logarithmicDepthBuffer: true }} camera={{ position: [0, CAMERA_HEIGHT, 0], fov: fov }}>
				...
				<ambientLight color='#f0f5fb' intensity={.5}/>
				{/* <pointLight
					castShadow
					intensity={2.0}
					color={0xefdfd5}
